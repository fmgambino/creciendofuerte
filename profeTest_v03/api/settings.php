...
function settings_defaults(){return [
 ...
 'smtp_enabled'=>'0','smtp_host'=>'','smtp_port'=>'587','smtp_username'=>'','smtp_password'=>'','smtp_secure'=>'tls','smtp_from_email'=>'','smtp_from_name'=>'EL MASTER PROFE CRM'
];}
...
$allowed=['app_title','app_short_title','app_subtitle','title_color','subtitle_color','brand_color','accent_color','footer_text','footer_url','smtp_enabled','smtp_host','smtp_port','smtp_username','smtp_password','smtp_secure','smtp_from_email','smtp_from_name'];
...
$files=['logo'=>'logo_path','favicon'=>'favicon_path','pwa_icon'=>'pwa_icon_path','email_logo'=>'email_logo_path'];
