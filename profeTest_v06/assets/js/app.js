...
async function configuraciones(){
 ...
 <form id="settingsForm" class="settings-grid">
  ...
  <div class="field"><label>Fondo login: tipo</label><select name="login_bg_type"><option value="css" ${String(c.login_bg_type||'css')==='css'?'selected':''}>Animación CSS</option><option value="image" ${String(c.login_bg_type||'')==='image'?'selected':''}>URL imagen</option><option value="video" ${String(c.login_bg_type||'')==='video'?'selected':''}>URL video</option></select></div>
  <div class="field full"><label>URL Video/Imagen para bloque derecho del login</label><input name="login_bg_url" value="${c.login_bg_url||''}" placeholder="https://.../fondo.mp4 o https://.../imagen.webp"></div>
